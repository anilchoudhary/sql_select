...
select * from employees where first_name='Elvis' or first_name = 'Denis';
...
select * from employee where first_name in ('Cathie', 'Mark', 'Nathan');



-- NOT IN
select * from employee where first_name not in ('Cathie', 'Mark', 'Nathan');
...
select * from employee where hire_date > '1997-01-01';
...
select * from employee where hire_date < '1997-02-01';
...
select * from employees where gender='F' and hire_date >= '1999-01-01';



-- 6.9: Extract a list with employees' salaries higher than 50,000 dollars per annum

select salary from salaries where salary > 50000;
...
select * from salaries where salary > 50000 order by salary desc;
...
select count(first_name) as FirstName_Count from employees


-- Let's count how many distinct first names we have in the employees table

select distinct first_name, count(*) as Names_Counts from employees group by first_name order by first_name;
